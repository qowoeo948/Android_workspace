...
public class MyView extends View {
    ...
    Paint paint;
    int x=300,y=300;
    Thread gameThread; //메인 쓰레드를 무한루프에 빠지게 하면 안되므로, 별도의 쓰레드 사용
    ...
    //xml에서 사용할 거면, xml의 속성까지 넘겨받아야하므로, AttributeSet이 있는 생성자도 정의하자
    ...
    //주의 javaSE에서는 팔레트가 Graphics 객체이지만, 안드로이드에서는 Canvas이다
    //즉 도화지가 아니다다
