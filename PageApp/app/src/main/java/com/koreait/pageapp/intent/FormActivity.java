...
public class FormActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final  int REQUEST_CODE=1;   //내가 정한 것임.. 통신의 무결성을 위해
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_send.setOnClickListener(this);   //위젯 버튼과 리스너와의 연결결
    ...
    //다른 액티비티를 호출하자!!
    public void send(){
        //아래와같이 대상클래스를 정확히 명시하는 인텐트 사용법을 가리켜 명시적(explicit) 인텐트라 한다.
        Intent intent = new Intent(this,ReceiveActivity.class);

        //intent는 jsp의 request,application,session객체처럼 데이터를 심을 수 있다.
        ...
        startActivity(intent);  //적재 시켜서 이제 출발!
    }
    ...
    public void sendAndGet(){
        ...
        //그냥 출발이 아니라, 결과를 받아 올 것을 염두해둔 출발
        //(전달할 데이터, 요청구분코드)
    ...
    public void callPhone(){
        //우리가 제작중인 현재 앱안에 있는 액티비티가 아니라, 외부 앱의 액티비티 명??
        //결론: 다른앱의 액티비티는 우리가 알수도 없고, 알 필요도 없다.
        //암시적,묵시적(implicit)인텐트를 사용하면 된다.
        //안드로이드의 Intent가 자체적으로 가진 상수들이 있다.. 이 상수들을 이용하면 안드로이드가
        //해석하는데 도움이 된다..
        Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:01033777878"));
