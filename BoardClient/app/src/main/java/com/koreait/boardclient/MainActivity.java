...
public class MainActivity extends AppCompatActivity {
    ...
    public void getList(View view){
        ...
        Thread thread = new Thread(){
            @Override
            public void run() {
                  ArrayList<Board> boardList = httpManager.requestByGet("http://192.168.1.2:7777/rest/board");
    ...
    public void regist(View view){
        Thread thread = new Thread(){
            ...
            public void run() {
                ...
                httpManager.requestByPost("http://192.168.1.2:7777/rest/board",json.toString());
